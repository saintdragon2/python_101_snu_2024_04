...
# 사용자 : 제 이름은 서교 입니다.  서울대학교에서 교수를 하고 있어요. 
# GPT  :     안녕하세요, 서교 교수님! 서울대학교에서 교수로 계시다니 정말 대단하시네요. 교수님의 고민이나 저에게 도움을 요청하실 사항이 있으신가요?
# 사용자 : 제 이름이 뭘까요? 
# GPT  :     제가 사용자님의 개인 정보를 저장하거나 알지 못하기 때문에 사용자님의 이름을 정확히 알 수 없습니다. 사용자님이 이름을 알려주시면 그 이름으로 대화를 이어갈 수 있습니다. 이름을 알려주시겠어요?
# 사용자 : 서교라고요. 
# GPT  :     안녕하세요, 서교님! 만나서 반갑습니다. 무엇에 대해 이야기하고 싶으신가요? 어떤 고민이 있으시다면 편하게 말씀해주세요.
# 사용자 : 제 이름은 뭘까요? 
